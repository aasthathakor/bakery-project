...
const Slide: React.FC<propsType> = ({ img, title, mainTitle, price }) => {
  return (
    <div className='outline-none border-none relative'>
        <div className='absulate left-[30px] md:left-[70px] max-w-[250px] sm:max-w-[350px] top-
        ...
        sm:p-0 rounded-lg sm:rounded-none'>
          ...
          <h2 className='text-blackish text-[24px] md:text-[30px] lg:text-[44px] font-bold leading [1.2]'>
          {mainTitle}
          </h2>
